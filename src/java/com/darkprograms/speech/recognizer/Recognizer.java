...
public class Recognizer {
   ...
   /**
     ...
     */
    public GoogleResponse getRecognizedDataForWave(File waveFile, int maxResults) throws IOException, JSONException{
        FlatEncoder flacEncoder = new FlatEncoder();
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForWave(String waveFile, int maxResults) throws IOException, JSONException {
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForFlac(File flacFile, int maxResults) throws IOException, JSONException {
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForFlac(File flacFile, int maxResults, int sampleRate) throws IOException, JSONException{
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForFlac(String flacFile, int maxResults, int sampleRate) throws IOException, JSONException{
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForFlac(String flacFile, int maxResults) throws IOException, JSONException {
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForWave(File waveFile) throws IOException, JSONException {
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForWave(String waveFile) throws IOException, JSONException {
        return getRecognizedDataForWave(waveFile, 1);
    }
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForFlac(File flacFile) throws IOException, JSONException {
     ...
     * @throws JSONException 
     */
    public GoogleResponse getRecognizedDataForFlac(String flacFile) throws IOException, JSONException {
        return getRecognizedDataForFlac(flacFile, 1);
    }
